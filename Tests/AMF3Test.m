...
- (NSString *)description{
    return [NSString stringWithFormat:@"<%@ = 0x%08lx> name: %@, child:\n-> %@", [self className], 
...
- (void)testNumber{
	...
	XCTAssertTrue([self assertDataOfFile:@"number_0.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_0.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:0x35];
	XCTAssertTrue([self assertDataOfFile:@"number_1.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_1.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:0x7f];
	XCTAssertTrue([self assertDataOfFile:@"number_2.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_2.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:0x80];
	XCTAssertTrue([self assertDataOfFile:@"number_3.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_3.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:0xd4];
	XCTAssertTrue([self assertDataOfFile:@"number_4.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_4.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:0x3fff];
	XCTAssertTrue([self assertDataOfFile:@"number_5.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_5.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:0x4000];
	XCTAssertTrue([self assertDataOfFile:@"number_6.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_6.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:0x1a53f];
	XCTAssertTrue([self assertDataOfFile:@"number_7.amf3" 
		isEqualTo:num], @"Numbers do not match");
	...
	XCTAssertTrue([self assertDataOfFile:@"number_8.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_8.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:0x200000];
	XCTAssertTrue([self assertDataOfFile:@"number_9.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_9.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:-0x01];
	XCTAssertTrue([self assertDataOfFile:@"number_10.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_10.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:-0x2a];
	XCTAssertTrue([self assertDataOfFile:@"number_11.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_11.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:0xfffffff];
	XCTAssertTrue([self assertDataOfFile:@"number_12.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_12.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithInt:-0x10000000];
	XCTAssertTrue([self assertDataOfFile:@"number_13.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_13.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithDouble:0x10000000];
	XCTAssertTrue([self assertDataOfFile:@"number_14.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_14.amf3"], 
		@"Number data is not equal");
		
	num = [NSNumber numberWithDouble:-0x10000001];
	XCTAssertTrue([self assertDataOfFile:@"number_15.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_15.amf3"], 
		@"Number data is not equal");
	
	num = [NSNumber numberWithDouble:0.1];
	XCTAssertTrue([self assertDataOfFile:@"number_16.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_16.amf3"], 
		@"Number data is not equal");
	
	num = [NSNumber numberWithDouble:0.123456789];
	XCTAssertTrue([self assertDataOfFile:@"number_17.amf3" 
		isEqualTo:num], @"Numbers do not match");
		
	XCTAssertTrue([self assertEncodedObject:num isEqualToContentsOfFile:@"number_17.amf3"], 
		@"Number data is not equal");
}

- (void)testBoolean{
	XCTAssertTrue([self assertDataOfFile:@"boolean_0.amf3" 
	...
	XCTAssertTrue([self assertDataOfFile:@"boolean_1.amf3" 
...
- (void)testNull{
	XCTAssertTrue([self assertDataOfFile:@"null_0.amf3" 
		isEqualTo:nil], @"Could not read null value");
		
	XCTAssertTrue([self assertEncodedObject:[NSNull null] isEqualToContentsOfFile:@"null_0.amf3"], 
		@"Null data is not equal");
		
	XCTAssertTrue([self assertEncodedObject:nil isEqualToContentsOfFile:@"null_0.amf3"], 
		@"Nil data is not equal");
}

- (void)testString{
	NSString *str = @"hello";
	XCTAssertTrue([self assertDataOfFile:@"string_0.amf3" 
		isEqualTo:str], @"Strings do not match");
		
	XCTAssertTrue([self assertEncodedObject:str isEqualToContentsOfFile:@"string_0.amf3"], 
		@"String data is not equal");
		
	str = @"ᚠᛇᚻ";
	XCTAssertTrue([self assertDataOfFile:@"string_1.amf3" 
		isEqualTo:str], @"Strings do not match");
		
	XCTAssertTrue([self assertEncodedObject:str isEqualToContentsOfFile:@"string_1.amf3"], 
		@"String data is not equal");
	
	XCTAssertTrue([self assertDataOfFile:@"string_2.amf3" isEqualTo:@"Hello World Åäö!"], 
...
- (void)testArray{
	...
	XCTAssertTrue([self assertDataOfFile:@"array_0.amf3" 
		isEqualTo:arr], @"Arrays do not match");

	XCTAssertTrue([self assertEncodedObject:arr isEqualToContentsOfFile:@"array_0.amf3"], 
		@"Array data is not equal");
}

- (void)testDictionary{
	NSDictionary *dict = [NSDictionary dictionaryWithObject:@"eggs" forKey:@"spam"];
	XCTAssertTrue([self assertDataOfFile:@"dictionary_0.amf3" 
		isEqualTo:dict], @"Dictionaries do not match");
		
	XCTAssertTrue([self assertEncodedObject:dict isEqualToContentsOfFile:@"dictionary_0.amf3"], 
...
//		@"d", @"d", nil];
//	XCTAssertTrue([self assertDataOfFile:@"dictionary_1.amf3" 
//		isEqualTo:dict], @"Dictionaries do not match");
//		
//	XCTAssertTrue([self assertEncodedObject:dict isEqualToContentsOfFile:@"dictionary_1.amf3"], 
//		@"Dictionary data is not equal");
}
		...
		[NSArray arrayWithObjects:
			...
			[[FlexArrayCollection alloc] initWithSource:
				[NSArray arrayWithObjects:
					...
					nil]], nil]];
	XCTAssertTrue([self assertDataOfFile:@"flexdatatypes_0.amf3" isEqualTo:coll], 
		@"ArrayCollections do not match.");
	XCTAssertTrue([self assertEncodedObject:coll isEqualToContentsOfFile:@"flexdatatypes_0.amf3"], 
...
- (void)testOptions{
	...
	XCTAssertTrue([self assertDataOfFile:@"flexdatatypes_0.amf3" isEqualTo:arr], 
		@"Arrays do not match.");
	XCTAssertTrue([self assertEncodedObject:arr isEqualToContentsOfFile:@"flexdatatypes_0.amf3"], 
		@"Array data is not equal");
...
- (void)testKeyedNonKeyedIntegrity{
	...
	XCTAssertThrows([AMFArchiver archivedDataWithRootObject:obj encoding:kAMF3Encoding], 
...
- (void)testExternalizable{
	...
	XCTAssertTrue([self assertDataOfFile:@"plainstringexternalizable_0.amf3" isEqualTo:obj], 
		@"Could not deserialize utf bytes");
	XCTAssertTrue([self assertEncodedObject:obj isEqualToContentsOfFile:@"plainstringexternalizable_0.amf3"], 
...
- (void)testExternalizableData{
	...
	XCTAssertTrue([self assertEncodedObject:obj isEqualToContentsOfFile:@"externalizabledata.amf3"], 
...
- (void)testNestedExternalizable{
	...
	XCTAssertTrue([parent isEqual:decodedParent], @"Original & decoded objects should be equal");
	[subChild release];
	[child release];
	[parent release];
}
...
- (void)testByteArray{
	...
	XCTAssertTrue([self assertDataOfFile:@"bytearray_0.amf3" isEqualTo:data], 
		@"Could not deserialize ByteArray properly");
	XCTAssertTrue([self assertEncodedObject:data isEqualToContentsOfFile:@"bytearray_0.amf3"], 
