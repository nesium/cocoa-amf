...
{
	if ([theDictionary objectForKey:@"_type_"] != nil)
	{
		NSString *type = [theDictionary objectForKey:@"_type_"];
		[theDictionary removeObjectForKey:@"_type_"];
		*outDictionary = (id)[ASObject asObjectWithDictionary:(NSDictionary *)theDictionary];
		[(ASObject *)*outDictionary setType:type];
	}
	else
	{
